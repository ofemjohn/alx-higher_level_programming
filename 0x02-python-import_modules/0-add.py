...
<div class="SelectMenu">
  ...
  <div data-view-component="true">      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li>
          <clipboard-copy data-toggle-for="blob-more-options-details" aria-label="Copy path" value="0x02-python-import_modules/0-add.py" data-view-component="true" class="dropdown-item cursor-pointer">
